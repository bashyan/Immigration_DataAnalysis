...
public class immigrantban 
{
	...
	public static class taxMapper extends Mapper<LongWritable, Text, LongWritable, Text> 
	{
		...
		public void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException 
		{
			...
			if(age > 14)
			{
				...
				context.write(new LongWritable(0),new Text("Tax\t"+record));
			}			
		}
	...
	public static class medianMapper extends Mapper<LongWritable, Text, LongWritable, Text> 
	{
		...
		public void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException 
		{
			...
			context.write(new LongWritable(1), new Text("Mean\t"+incval));
					//context.write(new LongWritable(1), new Text("Mean\t"+Double.toString(income)));
				/*
				if(s % 2 == 0)
				{
	...
	public static class banReducer extends Reducer<LongWritable, Text, LongWritable, Text> 
	{
		public void reduce(LongWritable key, Iterable<Text> values, Context context)throws IOException, InterruptedException 
		{
			...
			for (Text entry : values) 
			{
				...
				else if (parts[0].equals("Mean")) 
				{
					count++;
					tempmean += Double.parseDouble(parts[1]);
				}
			}
			...
			String result = "Total Tax : "+tax+"\tMeanIncome : "+mean;
